abstract  class  Vehicle  implements  GPS  { 
    ...
    public  Vehicle  (  int  vehicleId,String driverName,  double  ratePerKm,String 
    currentLocation){ 
    ...
    public  Car  (  int  vehicleId, String driverName,  double  ratePerKm,String 
    location) { 
    ...
    public  Bike  (  int  vehicleId, String driverName,  double  ratePerKm,String 
    location) { 
    super  (vehicleId, driverName, ratePerKm,location); 
    } 
    @Override 
    ...
    public  Auto  (  int  vehicleId, String driverName,  double  ratePerKm,String 
    location) { 
    super  (vehicleId, driverName, ratePerKm,location); 
    } 
    @Override 
